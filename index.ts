...
const quiz: {
  ...
  },
  {
    ...
    type: "list",
    message:
      "q6.How do you compile a TypeScript file named 'app.ts' to JavaScript?",
    choices: [
      "tsc app.ts",
      "tsc compile app.ts",
      "typescript app.ts",
  ...
  },
  {
    ...
    type: "list",
    message:
      "q7.Which of the following is a valid way to create an interface in TypeScript?",
    choices: [
  ...
  },
  {
    ...
    type: "list",
    message:
      "q8.Which TypeScript feature allows you to catch errors at compile time rather than at runtime?",
    choices: [
      "Dynamic typing",
      "Static typing",
      "Polymorphism",
  ...
  },
  {
    ...
    type: "list",
    message:
      "q9.Which of the following TypeScript feature helps to describe the shape of an object?",
  ...
  },
  {
    ...
    type: "list",
    message:
      "q10.How can you define an optional property in a TypeScript interface?",
    choices: [
      "propertyName?: type",
      "propertyName: type?",
